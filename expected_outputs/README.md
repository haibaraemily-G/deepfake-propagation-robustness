...
The first file supports manuscript Table 1. The AUC bootstrap summary supports
manuscript Table 2. The FDR bootstrap summary supplies the Table 1 confidence
intervals and remains available as an audit-friendly detailed output.
